/**
 * @fileOverview Zod schemas and TypeScript types for the weather feature.
 * This file is separate to allow the schemas to be imported into both client
 * and server components without violating the 'use server' directive.
 */
...
export const WeatherOutputSchema = z.object({
    ...
    wind: z.string().describe("The wind speed, e.g., '12 km/h'.").optional(),
    ...
    })).max(5).describe("A 5-day weather forecast.").optional(),
